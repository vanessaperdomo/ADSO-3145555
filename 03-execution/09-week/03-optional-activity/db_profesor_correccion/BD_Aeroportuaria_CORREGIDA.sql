-- ============================================================
-- BASE DE DATOS AEROPORTUARIA - VERSIÓN CORREGIDA
-- Autora: Laura Vanessa Pérez Perdomo
-- ADSO - SENA 2026
-- Motor: PostgreSQL 16
-- ============================================================
-- CORRECCIONES APLICADAS:
-- E-01: Se mantiene convención nombre_tabla_id para PKs (estándar
--       relacional). Las PKs ya siguen la convención correcta.
-- E-02: Tabla fare: se elimina dependencia transitiva de airport_name
--       (no existía, pero se documenta la validación realizada).
-- E-03: seat_assignment: se agregaron FK explícitas faltantes.
-- E-04: maintenance_event: status_code como CHECK, se agrega tabla
--       catálogo maintenance_status para extensibilidad.
-- E-05: baggage: baggage_type y baggage_status se convierten a FK
--       usando tablas catálogo.
-- E-06: reservation_passenger: passenger_type se convierte a FK.
-- E-07: boarding_validation: validation_result se convierte a FK.
-- E-08: Trigger faltante para updated_at (se agrega función universal).
-- ============================================================
...
-- CORRECCIÓN E-04: Nueva tabla catálogo para estados de mantenimiento
...
CREATE TABLE maintenance_event (
    ...
    -- CORRECCIÓN E-04: FK a tabla catálogo en lugar de CHECK sobre varchar
...
-- CORRECCIÓN E-06: Nueva tabla catálogo para tipo de pasajero
...
CREATE TABLE reservation_passenger (
    ...
    person_id uuid NOT NULL REFERENCES person(person_id),
    -- CORRECCIÓN E-06: FK a tabla catálogo en lugar de CHECK sobre varchar
...
CREATE TABLE ticket_segment (
    ...
    -- CORRECCIÓN E-03: Se elimina uq_ticket_segment_pair redundante que
    -- duplicaba la unicidad ya garantizada por uq_ticket_segment_flight.
    -- La FK compuesta en seat_assignment se mantiene correcta con las
    -- columnas (ticket_segment_id, flight_segment_id).
...
CREATE TABLE seat_assignment (
    ...
    -- CORRECCIÓN E-03: FK compuesta correcta apuntando a la PK compuesta de ticket_segment
...
-- CORRECCIÓN E-05: Tablas catálogo para baggage_type y baggage_status
...
CREATE TABLE baggage (
    ...
    -- CORRECCIÓN E-05: FK a tablas catálogo en lugar de CHECK sobre varchar
...
-- CORRECCIÓN E-07: Nueva tabla catálogo para resultado de validación
...
CREATE TABLE boarding_validation (
    ...
    -- CORRECCIÓN E-07: FK a tabla catálogo en lugar de CHECK sobre varchar
...
-- ============================================
-- CORRECCIÓN E-08: TRIGGER UNIVERSAL updated_at
-- ============================================
...
COMMENT ON TABLE maintenance_status IS 'CORRECCIÓN E-04: Catálogo de estados de mantenimiento reemplaza CHECK sobre varchar.';
COMMENT ON TABLE baggage_type IS 'CORRECCIÓN E-05: Catálogo de tipos de equipaje reemplaza CHECK sobre varchar.';
COMMENT ON TABLE baggage_status IS 'CORRECCIÓN E-05: Catálogo de estados de equipaje reemplaza CHECK sobre varchar.';
COMMENT ON TABLE passenger_type IS 'CORRECCIÓN E-06: Catálogo de tipos de pasajero reemplaza CHECK sobre varchar.';
COMMENT ON TABLE validation_result_type IS 'CORRECCIÓN E-07: Catálogo de resultados de validación reemplaza CHECK sobre varchar.';
